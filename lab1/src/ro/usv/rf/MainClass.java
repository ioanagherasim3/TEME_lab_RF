...
public class MainClass {
	...
	private static double[][] normalizeLearningSet(double[][] learningSet) {
		...
		for(int row=0;row<learningSet.length;row++)
		{
			...
			{
				normalizedLearningSet[row][column]=(learningSet[row][column]-min[column])/(max[column]-min[column]);
			}
		}
	...
	public static void main(String[] args) {
		double[][] learningSet = FileUtils.readLearningSetFromFile("C:\\Users\\Student\\eclipse-workspace\\lab1\\in.txt");
		FileUtils.writeLearningSetToFile("C:\\Users\\Student\\eclipse-workspace\\lab1\\out.txt",
